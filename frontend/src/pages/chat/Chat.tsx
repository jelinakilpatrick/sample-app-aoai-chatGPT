                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Hi there, I'm DSDIL-<em>GPT</em></h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>I'm a secure, internal chatbot to assist DSDILGP staff. Let's have a crack at this!</h2>
                            </Stack>
                        ) : (
